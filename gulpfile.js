...
gulp.task("default", function(callback) {
  ...
  console.log("install-bower      - Runs 'bower install' in '" + __dirname + "/plugins/web'")
  console.log("less               - Compiles all LESS files in " + __dirname + "/plugins/web/public/stylesheets'")
  callback()
})
...
gulp.task('less', function (callback) {
  ...
  return gulp.src('./plugins/web/public/stylesheets/*.less')
    .pipe(less({
