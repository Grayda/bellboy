    ...
    play: function(file, loop) {
      ...
      try {
        ...
        if (os.platform() !== "win32") {
          ...
          proc = cp.exec("mpg123 " + loop + " \"" + options.options.audioPath + "/" + file + "\"", function(error, stdout, stderr) {
          ...
          proc = cp.exec("\"" + __dirname + "/mpg123/mpg123.exe\" " + loop + " \"" + options.options.audioPath + "/" + file + "\" ", function(error, stdout, stderr) {
            imports.logger.log(stdout || stderr || error, 1)
          })
