...
NOTE: This plugin uses `mpg123` which can be downloaded from [the mpg123 website](http://www.mpg123.de/download/). If running on bellboy, use `sudo apt-get install mpg123`
